...
GLuint shader_program = 0; // shader program to set render color pipeline
...
GLint mv_location, proj_location, mv_locationTex, proj_locationTex; // Uniforms for transformation matrices
